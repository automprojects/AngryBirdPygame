...
background_image = pygame.image.load("angry_bird_pygame/background.png")  # Replace with your actual image filename
...
while True:
    for event in pygame.event.get():
        ...
        # ... (Previous event handling remains the same)
    ...
    if len(enemy_birds) == 0:
        try_again_counter = 0
        level_cleared = True  # Set the level cleared flag
    ...
    # Display "Level Cleared" if all enemies are hit down
    if level_cleared:
